                ...
                <div class="card-body">
                    <form name="form">
                        <div class="form-group">
                            ...
                            <input type="text" name="judul" id="judul" class="form-control" placeholder="Judul Berita" maxlength="80">
                            <code class="text-xs">* Maximal 80 karakter</code>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-lg-6">
                                <label>Cover Berita</label>
                                <input type="file" name="cover" id="cover" class="form-control" placeholder="Cover Berita">
...
<script>
    $(document).ready(function() {
        ...
        $("#simpanberita").click(function(e) {
            ...
            form_data.append('berita', berita);

            $.ajax({
                url: "<?= site_url('samsat/saveberita') ?>",
                dataType: 'text',
                cache: false,
                contentType: false,
                processData: false,
