    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <a href="<?= base_url('samsat/tambahberita') ?>" class="btn btn-success"><i class="fas fa-plus"></i> Tambah Berita</a>
...
<script>
    ...
    $(document).ready(function() {
        table = $('#dataTable').DataTable({
            ...
            "order": [],
            "ajax": {
                "url": "<?= site_url('samsat/listberita_data') ?>",
                "type": "POST"
            },
            "columnDefs": [{
                "targets": [0, 5],
    ...
    function hapus_data(id) {
        ...
        swal({
            ...
            if (isConfirm) {
                $.ajax({
                    url: "<?= site_url('samsat/deleteberita') ?>",
                    type: "POST",
                    dataType: "JSON",
                    data: {
                        id: id,
