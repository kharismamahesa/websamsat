...
{
    var $table = 'samsat_realtime';
    var $column_order = array(null, 'tanggal', 'total', null, null, null);
    var $column_search = array('tanggal', 'total');
    var $order = array(
        // 'kategori_unit' => 'ASC',
        // 'jenis_pajak' => 'ASC',
        'tanggal' => 'DESC',
    ...
    private function _get_datatables_query()
    {
        ...
        // } else {
        $this->db->select('*')
            ->from('samsat_realtime')
            ->where('samsat_realtime.kantor_id', $this->kantor_id);
        // }
