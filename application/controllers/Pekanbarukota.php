...
class Pekanbarukota extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->load->view('pekanbarukota/header', $data);
		$this->load->view('pekanbarukota/halamanutama', $data);
	}
	...
	public function semuaberita()
	{
		...
		$kantor_id = 1;
		$config['base_url'] = base_url('pekanbarukota/semuaberita');
		...
		$data = array(
			'title' => 'Berita - Samsat Pekanbaru Kota',
		...
		$this->load->view('pekanbarukota/header', $data);
		$this->load->view('pekanbarukota/semuaberita', $data);
	}
	...
	public function detailberita()
	{
		...
		if ($getberitabylink->num_rows() > 0) {
			...
			$this->load->view('pekanbarukota/header', $data);
			$this->load->view('pekanbarukota/detailberita', $data);
		} else {
			echo "<script>window.alert('Anda mengakses URL yang salah');
						window.location=('" . base_url('/pekanbarukota') . "')</script>";
		}
	}
	...
	public function semuavideo()
	{
		...
		$kantor_id = 1;
		$config['base_url'] = base_url('pekanbarukota/semuavideo');
		...
		$this->load->view('pekanbarukota/header', $data);
		$this->load->view('pekanbarukota/semuavideo', $data);
	}

	public function strukturorganisasi()
	{
		$data = array(
			'title' => 'Struktur Organisasi - Samsat Pekanbaru Kota',
			'getallberita' => $this->model_samsat_berita->getAllbyKantor(1),
		);
		$this->load->view('pekanbarukota/header', $data);
		$this->load->view('pekanbarukota/strukturorganisasi', $data);
	}
	...
	public function visimisi()
	{
		...
		$this->load->view('pekanbarukota/header', $data);
		$this->load->view('pekanbarukota/visimisi', $data);
	}

	public function datasurvei()
	{
		$arr_datapendidikan = [];
		$datapendidikan =  $this->model_samsat_survei->getDSPendidikan(1)->result();
		...
		$datajeniskelamin =  $this->model_samsat_survei->getDSKelamin(1)->result();
	...
	public function unit()
	{
		...
		if ($link5 == '') {
			echo "<script>window.location=('" . base_url('pekanbarukota') . "')</script>";
		} else {
			...
			$this->load->view('pekanbarukota/header', $data);
			$this->load->view('pekanbarukota/unit', $data);
		}
	}
	...
	public function faq()
	{
		...
		if ($link == '') {
			...
			$this->load->view('pekanbarukota/header', $data);
			$this->load->view('pekanbarukota/faq', $data);
		} else {
			$data = array(
			...
			$this->load->view('pekanbarukota/header', $data);
			$this->load->view('pekanbarukota/faqdetail', $data);
		}
	}
	...
	public function realtime()
	{
		$tahunsekarang = date('Y');
		$data = array(
			'title' => 'Realtime Penerimaan - Samsat Pekanbaru Kota',
			'getdatarealtime' => $this->model_samsat_realtime->getRealtime(1992, $tahunsekarang),
			'getallberita' => $this->model_samsat_berita->getAllbyKantor(1),
		);
		$this->load->view('pekanbarukota/header', $data);
		$this->load->view('pekanbarukota/realtime', $data);
	}
