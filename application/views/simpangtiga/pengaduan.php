					...
					<div class="row">
						...
						<div class="col-md-6 text-center">
							<a href="https://www.lapor.go.id/" target="_blank">
								<img src="https://www.lapor.go.id/themes/lapor/assets/images/logo.png" style="border: 1px solid #000; border-radius: 7px; height: 80px;" class="img-fluid" alt="">
							</a>
						</div>
