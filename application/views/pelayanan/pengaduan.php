					...
					<form method="post" action="#" class="php-email-form">
						<div class="row gy-4">
							...
							<div class="col-md-12 text-center">
								<img src="<?= base_url('assets/sipengat.png') ?>" class="w-75" alt="">
							</div>

							<div class="col-md-12">
								<div class="row">
									<label class="alert alert-success col-md-6" style="border-radius: 0px" for="jenis1">
										<input type="radio" id="jenis1" name="jenis" value="1">
										Pengaduan
									</label>
									<label class="alert alert-success col-md-6" style="border-radius: 0px" for="jenis2">
										<input type="radio" id="jenis2" name="jenis" value="2">
										Saran
									</label>
								</div>
							</div>
	...
	$(document).ready(function() {
		$('#btnpilihuptup').click(function() {
			...
			if ((jenis == undefined)) {
				Swal.fire({
					title: 'Peringatan!',
					text: 'Silahkan pilih jenis pengaduan terlebih dahulu',
					icon: 'error',
