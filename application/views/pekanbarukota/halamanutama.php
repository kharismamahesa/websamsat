...
<div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
	<div class="carousel-inner">
		<div class="carousel-item active">
			<img class="w-100" src="<?= base_url() ?>assets/img/samsat-pekanbaru-kota.jpeg" alt="Image">
			<div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
				<div class="p-3" style="max-width: 900px;">
					<h4 class="display-4 text-white mb-md-4 animated zoomIn">
						Selamat Datang di <br>Samsat Pekanbaru Kota
					</h4>
				</div>
			</div>
		</div>
		<div class="carousel-item">
			...
			<div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
				<div class="p-3" style="max-width: 900px;">
					<h4 class="display-4 text-white mb-md-4 animated zoomIn">
						UPT Pengelolaan Pendapatan <br>Pekanbaru Kota
					</h4>
				</div>
			</div>
		</div>
		...
		<div class="row gx-0">
			...
			<div class="col-lg-4 wow zoomIn" data-wow-delay="0.3s">
				<div class="bg-light shadow d-flex align-items-center justify-content-center p-4" style="height: 150px;">
					<a href="https://bapenda.riau.go.id/pelayanan/pengaduankirim?uptup=1&jenis=1" target="_blank">
						...
						<div class="col-lg-4 wow slideInUp" data-wow-delay="0.3s">
							<div style="min-height: 400px;" class="blog-item bg-light rounded overflow-hidden">
								...
								<div class="p-4">
									...
									<a class="text-secondary text-uppercase" href="<?= base_url('pekanbarukota/detailberita/') . $datanya['link'] ?>">SELENGKAPNYA <i class="bi bi-arrow-right"></i></a>
								</div>
							</div>
						</div>
...
<div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
	<div class="container py-5">
		<div class="row">
			...
			<div class="col-md-6">
				<div class="section-title text-center position-relative pb-3 mb-5 mx-auto" style="max-width: 600px;">
					<h5 class="fw-bold text-success text-uppercase">Video Dokumentasi</h5>
				</div>
				<div class="row g-5">
					<?php
					if ($lastvideo == '') {
