<div class="container-fluid bg-secondary py-5 bg-header" style="margin-bottom:30px;">
    <div class="row py-5">
        <div class="col-12 pt-lg-5 mt-lg-3 text-center">
            <h2 class="text-white animated zoomIn">Pengaduan</h2>
        </div>
    </div>
</div>
</div>
        ...
        <div class="row g-5">
            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                    ...
                    <h4 class="mb-3">SIPENGAT</h4>
                    <p class="m-0">Sistem Pengaduan Masyarakat BAPENDA Riau</p>
                    <a class="btn btn-lg btn-success rounded" href="https://bapenda.riau.go.id/pelayanan/pengaduan/pengaduan_isi?jenis=1&tujuan=1">
            ...
            <div class="col-lg-4 col-md-6 wow zoomIn" data-wow-delay="0.3s">
                <div class="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
                    ...
                    <h4 class="mb-3">LAPOR</h4>
                    <p class="m-0">SP4N Lapor KEMENPAN</p>
                    <a class="btn btn-lg btn-success rounded" href="https://www.lapor.go.id/">
                        <i class="bi bi-arrow-right"></i>
                    </a>
                </div>
            </div>
