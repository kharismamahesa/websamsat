<div class="container-fluid bg-secondary py-5 bg-header" style="margin-bottom:30px;">
	<div class="row py-5">
		<div class="col-12 pt-lg-5 mt-lg-3 text-center">
			...
			<a href="https://bapenda.riau.go.id/pelayanan/surveikirim?uptup=10" target="_blank" class="btn btn-success text-center"><i class="fa fa-list"></i> Silahkan Isi Survei Berikut</a>
		</div>
...
<?php
$umur1 = $this->model_samsat_survei->umur1(10)->row()->jumlah;
$umur2 = $this->model_samsat_survei->umur2(10)->row()->jumlah;
$umur3 = $this->model_samsat_survei->umur3(10)->row()->jumlah;
$umur4 = $this->model_samsat_survei->umur4(10)->row()->jumlah;
$umur5 = $this->model_samsat_survei->umur5(10)->row()->jumlah;
?>
