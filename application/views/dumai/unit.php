			...
			?>
				<div class="col-lg-6">
					<div class="d-flex wow fadeIn" data-wow-delay="0.1s">
						...
						<div class="ps-4">
							<h5 class="mb-2">Hari Senin di Kantor Jasa Raharja Dumai</h5>
							<h4 class="text-success mb-0">09.00 s/d 12.00</h4>
						</div>
						<div class="ps-4">
							<h5 class="mb-2">Hari Selasa di Toko Furniture Purnama Mandiri</h5>
							<h4 class="text-success mb-0">09.00 s/d 12.00</h4>
						</div>
						<div class="ps-4">
							<h5 class="mb-2">Hari Rabu di Apotek Raga Farma</h5>
							<h4 class="text-success mb-0">09.00 s/d 12.00</h4>
						</div>
						<div class="ps-4">
							<h5 class="mb-2">Hari Kamis di Dealer Motor Honda CV Asia Motor</h5>
							<h4 class="text-success mb-0">09.00 s/d 12.00</h4>
						</div>
					</div>
				</div>
